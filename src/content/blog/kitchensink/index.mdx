...
## <a name="Admonitions"></a>Admonitions (Callouts)

:::note
Đây là một ghi chú (note). Thường dùng để làm nổi bật thông tin thêm hoặc ngữ cảnh quan trọng.
:::

:::tip
Đây là một mẹo (tip). Dùng để chia sẻ các thủ thuật hoặc gợi ý hữu ích.
:::

:::important
Đây là thông tin quan trọng (important). Người đọc cần đặc biệt chú ý đến nội dung này.
:::

:::caution
Đây là một lời cảnh báo nhẹ (caution). Dùng để khuyên người đọc nên cẩn thận hoặc tránh một số sai lầm.
:::

:::warning
Đây là cảnh báo nguy hiểm (warning). Dùng cho các lỗi nghiêm trọng, rủi ro về bảo mật hoặc mất dữ liệu!
:::

[[Top]](#top)

## <a name="TaskLists"></a>Task Lists

- [x] Công việc đã hoàn thành
- [x] Lên ý tưởng bài viết
- [ ] Công việc chưa hoàn thành
- [ ] Chỉnh sửa và đăng bài

[[Top]](#top)

## <a name="Strikethrough"></a>Strikethrough (Gạch ngang chữ)

Nội dung này bao gồm ~~văn bản bị gạch ngang~~, thường dùng để biểu thị thông tin đã cũ hoặc không còn chính xác.

[[Top]](#top)

## <a name="Footnotes"></a>Footnotes (Chú thích cuối trang)

Đây là một câu chứa chú thích cuối trang[^1]. Bạn có thể thêm một chú thích khác ở đây[^2].

[^1]: Đây là nội dung chi tiết của chú thích đầu tiên.
[^2]: Đây là nội dung chi tiết của chú thích thứ hai.

[[Top]](#top)

## <a name="VideoEmbed"></a>Video Embed
